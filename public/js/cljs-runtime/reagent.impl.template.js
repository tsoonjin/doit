...
var G__37634 = o;
reagent.impl.template.goog$module$goog$object.set(G__37634,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37722__delegate = function (args){
...
while (G__37723__i < G__37723__a.length) {G__37723__a[G__37723__i] = arguments[G__37723__i + 0]; ++G__37723__i;}
  args = new cljs.core.IndexedSeq(G__37723__a,0,null);
} 
return G__37722__delegate.call(this,args);};
G__37722.cljs$lang$maxFixedArity = 0;
G__37722.cljs$lang$applyTo = (function (arglist__37724){
var args = cljs.core.seq(arglist__37724);
return G__37722__delegate(args);
});
...
var G__37637 = o;
reagent.impl.template.goog$module$goog$object.set(G__37637,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__37642 = props;
var G__37642__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37642,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37642);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37642__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var temp__5757__auto___37739 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37739 == null)){
} else {
var key_37740 = temp__5757__auto___37739;
(jsprops.key = key_37740);
}
...
var temp__5757__auto___37743 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37743 == null)){
} else {
var key_37745 = temp__5757__auto___37743;
...
var temp__5757__auto___37751 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37751 == null)){
} else {
var key_37752 = temp__5757__auto___37751;
(jsprops.key = key_37752);
}
...
var temp__5757__auto___37763 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37763 == null)){
} else {
var key_37764 = temp__5757__auto___37763;
(jsprops.key = key_37764);
}
...
var temp__5757__auto___37767 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37767 == null)){
} else {
var key_37768 = temp__5757__auto___37767;
(jsprops.key = key_37768);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37691_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37691_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37694 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37694,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37694,(1),null);
...
break;
default:
var G__37785 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37786 = compiler;
v = G__37785;
compiler = G__37786;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37714 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37714 = (function (opts,id,fn_to_element,parse_fn,meta37715){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37714.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37716,meta37715__$1){
var self__ = this;
var _37716__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37714(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37715__$1));
}));

(reagent.impl.template.t_reagent$impl$template37714.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37716){
var self__ = this;
var _37716__$1 = this;
return self__.meta37715;
}));

(reagent.impl.template.t_reagent$impl$template37714.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37714.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37714.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37714.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37714.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37714.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37715","meta37715",-1290146726,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37714.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37714.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37714");

(reagent.impl.template.t_reagent$impl$template37714.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template37714");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37714.
 */
reagent.impl.template.__GT_t_reagent$impl$template37714 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37714(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37715){
return (new reagent.impl.template.t_reagent$impl$template37714(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37715));
});

}

return (new reagent.impl.template.t_reagent$impl$template37714(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
