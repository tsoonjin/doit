...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30523 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30523(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30533 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30533(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30538 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30538(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30539 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30539(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30561 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30561(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30562 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30562(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30563 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30563(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30565 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30565(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30566 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30566(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30567 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30567(b,itm);
}
});
