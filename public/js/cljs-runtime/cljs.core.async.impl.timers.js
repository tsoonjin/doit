...
var i_32553 = (0);
while(true){
if((i_32553 < arr.length)){
(arr[i_32553] = null);

var G__32555 = (i_32553 + (1));
i_32553 = G__32555;
continue;
} else {
}
...
var i_32567 = (self__.level + (1));
while(true){
if((i_32567 <= (new_level + (1)))){
(update[i_32567] = self__.header);

var G__32569 = (i_32567 + (1));
i_32567 = G__32569;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32570 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32570[i]));
} else {
x__$2.forward.push((((i < links_32570.length))?(links_32570[i]):null));
}

if((i < links_32570.length)){
(links_32570[i] = x__$2);
} else {
links_32570.push(x__$2);
}
...
var i_32574 = (0);
while(true){
if((i_32574 <= self__.level)){
var links_32575 = (update[i_32574]).forward;
if((x__$1 === (((i_32574 < links_32575.length))?(links_32575[i_32574]):null))){
(links_32575[i_32574] = (x__$1.forward[i_32574]));

var G__32580 = (i_32574 + (1));
i_32574 = G__32580;
continue;
} else {
var G__32581 = (i_32574 + (1));
i_32574 = G__32581;
continue;
}
} else {
...
var G__32590 = nx;
var G__32591 = (level__$1 - (1));
x = G__32590;
level__$1 = G__32591;
continue;
} else {
var G__32592 = x;
var G__32593 = (level__$1 - (1));
x = G__32592;
level__$1 = G__32593;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__32597 = nx;
var G__32598 = (level__$1 - (1));
x = G__32597;
level__$1 = G__32598;
continue;
} else {
var G__32604 = x;
var G__32605 = (level__$1 - (1));
x = G__32604;
level__$1 = G__32605;
continue;
}
