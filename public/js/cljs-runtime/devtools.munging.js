...
var o26889 = temp__5751__auto__;
var temp__5751__auto____$1 = (o26889["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o26890 = temp__5751__auto____$1;
return (o26890["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26629__auto__ = f;
return (o__26629__auto__["toString"]).call(o__26629__auto__);
} else {
return "";
}
}catch (e26894){var _ = e26894;
return "";
}});
...
try{var o__26629__auto___27439 = t;
(o__26629__auto___27439["cljs$lang$ctorPrWriter"]).call(o__26629__auto___27439,t,writer);
}catch (e26897){var __27440 = e26897;
}
...
var char_code = (function (){var o__26629__auto__ = (new String(char$));
return (o__26629__auto__["charCodeAt"]).call(o__26629__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26629__auto__ = String;
return (o__26629__auto__["fromCharCode"]).call(o__26629__auto__,subscript_code);
});
/**
...
var o__26629__auto__ = String;
return (o__26629__auto__["fromCharCode"]).call(o__26629__auto__,superscript_code);
});
/**
...
}catch (e26957){var _e__26654__auto__ = e26957;
return false;
}})())){
...
var vec__26959 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26959,(0),null);
...
var len__4864__auto___27472 = arguments.length;
var i__4865__auto___27474 = (0);
while(true){
if((i__4865__auto___27474 < len__4864__auto___27472)){
args__4870__auto__.push((arguments[i__4865__auto___27474]));

var G__27476 = (i__4865__auto___27474 + (1));
i__4865__auto___27474 = G__27476;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26993){
var vec__26995 = p__26993;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26995,(0),null);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26989){
var G__26990 = cljs.core.first(seq26989);
var seq26989__$1 = cljs.core.next(seq26989);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26990,seq26989__$1);
}));
...
var vec__27011 = cljs.core.split_with((function (p1__27010_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27010_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(1),null);
...
var vec__27019 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27019,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27019,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27492 = cljs.core.rest(remaining_tokens);
var G__27493 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27492;
name_tokens = G__27493;
continue;
} else {
...
var vec__27028 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27028,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27028,(1),null);
var vec__27031 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27031,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27031,(1),null);
var vec__27034 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27034,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27034,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27034,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27034,(3),null);
...
var vec__27052 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27052,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27067 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(1),null);
var vec__27070 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27070,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27070,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27092 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27092) : devtools.munging.parse_fn_info_deep.call(null,G__27092));
})()));
}
} else {
return fn_info;
...
var G__27518 = (arity + (1));
var G__27519 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27139){
var vec__27141 = p__27139;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27141,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27141,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27171_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27171_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27174_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27174_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27196){
var vec__27197 = p__27196;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27197,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27186){
var G__27187 = cljs.core.first(seq27186);
var seq27186__$1 = cljs.core.next(seq27186);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27187,seq27186__$1);
}));
...
var map__27273 = options;
var map__27273__$1 = cljs.core.__destructure_map(map__27273);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27273__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27273__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27273__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27273__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27274 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(5),null);
...
var o__26629__auto__ = f;
return (o__26629__auto__["getBasis"]).call(o__26629__auto__);
});
/**
...
}catch (e27301){var _e__26654__auto__ = e27301;
...
var G__27550 = (obj[cljs.core.first(path)]);
var G__27551 = cljs.core.rest(path);
obj = G__27550;
path = G__27551;
continue;
} else {
...
var _STAR_ = (function (accum,p__27350){
var vec__27351 = p__27350;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27351,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27351,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27379){
var vec__27382 = p__27379;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27382,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27382,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27382,(2),null);
...
var post_process = (function (p__27406){
var vec__27407 = p__27406;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27407,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27407,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27396_SHARP_){
return (obj[cljs.core.first(p1__27396_SHARP_)]);
}),sorted_matches);
