...
}catch (e27597){var _e = e27597;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___27630 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___27630)){
var seen_errors_27631 = temp__5751__auto___27630;
if(cljs.core.truth_(seen_errors_27631.has(self))){
} else {
seen_errors_27631.add(self);

var temp__5753__auto___27632 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___27632)){
var sense_27633 = temp__5753__auto___27632;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27633)].join(''));
} else {
}
}
} else {
