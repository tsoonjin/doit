...
var len__4864__auto___27703 = arguments.length;
var i__4865__auto___27704 = (0);
while(true){
if((i__4865__auto___27704 < len__4864__auto___27703)){
args__4870__auto__.push((arguments[i__4865__auto___27704]));

var G__27705 = (i__4865__auto___27704 + (1));
i__4865__auto___27704 = G__27705;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27634){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27635,G__27636,seq27634__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27652_SHARP_){
return (!((cljs.core.meta(p1__27652_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27672__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27673){var _e__26654__auto__ = e27673;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e27675){var _e__26654__auto__ = e27675;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27681 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27682 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27682);

try{var map__27687 = opts;
var map__27687__$1 = cljs.core.__destructure_map(map__27687);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27687__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27681);
}});
...
var temp__5751__auto___27713 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27713)){
var managed_print_level_27714 = temp__5751__auto___27713;
var _STAR_print_level_STAR__orig_val__27700_27715 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27701_27716 = managed_print_level_27714;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27701_27716);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27692_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27692_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27700_27715);
}} else {
job_fn();
}
